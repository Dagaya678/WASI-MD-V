...
global.allowJids = process.env.ALLOW_JID || "94756059852@s.whatsapp.net";
...
global.owner = process.env.OWNER_NUMBER || "94756059852";
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || "𝗗𝗮𝗴𝗮𝘆𝗮-𝐌𝐃-𝐕2",
  ownername: process.env.OWNER_NAME || "𝗗𝗔𝗚𝗔𝗬𝗔",
  errorChat: process.env.ERROR_CHAT || "94756059852",
